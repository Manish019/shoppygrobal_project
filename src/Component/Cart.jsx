...
function Cart() {
  // when i add the quantyty we can use it
  ...
  // clear all the cart itmes
  function handleItem() {
    dispatch(clearCart());
  }
  // one by one item deleatedd by id
  ...
  return (
    <>
      {/* 
    when i deleted all the items from cart than show in zero 
    */}
      {cartItems.length === 0 ? (
        <div>
          <div className="flex flex-col items-center justify-center h-[70vh] text-center">
            ...
            <Link
              to="/"
              className="bg-[#a52a2a] hover:bg-purple-700 text-white px-6 py-2 rounded-md font-medium mb-2"
            >
              ← Continue Shopping
            </Link>
        ...
        <div>
           <div className="max-w-10xl mx-auto px-5 py-1">
             <Link to="/product">
          ...
          <div className="max-w-7xl mx-auto px-6 py-10">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="w-full lg:w-1/3 bg-white rounded-lg border p-6">
                ...
                <Link to="/checkout">
                  <button className="mt-6 w-full bg-[#a52a2a] text-white py-2 rounded hover:bg-purple-700 font-semibold">
                    Proceed to Checkout
                  </button>
                </Link>
